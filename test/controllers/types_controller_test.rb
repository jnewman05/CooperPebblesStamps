...
class TypesControllerTest < ActionController::TestCase
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post :create, type: { abrev: @type.abrev, createat: @type.createat, id: @type.id, name: @type.name, updatear: @type.updatear }
    end
  ...
  test "should update type" do
    patch :update, id: @type, type: { abrev: @type.abrev, createat: @type.createat, id: @type.id, name: @type.name, updatear: @type.updatear }
    assert_redirected_to type_path(assigns(:type))
  end
